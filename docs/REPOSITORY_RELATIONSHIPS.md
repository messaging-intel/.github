...
# Repository relationships for `messaging-intel`
...
- Inventory digest: `sha256:893185b67057a2153451dd77316ff286f1a1f8f73e20ef605f61c43eb30e2ca0`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:messaging-intel` |
| GitHub owner ID | `308168184` |
| Linear project ID | `3f6f6aea-d1aa-41a6-949e-859ffc154882` |
...
|---|---|---|---|
| `messaging-intel/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
