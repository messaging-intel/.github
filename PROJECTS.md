...
| `msgint-connectors` | [`#28`](https://github.com/messaging-intel/msgint-connectors/pull/28) | `42092a2ecb767adeb0174776d0eeee73917b6c8b` | `a43e11cd7610806470c0af95f4cdbe3e19b143bb` | Private Zed manifest/lock and release boundary; local validator 6/6 with 12 mutations rejected; workflow syntax accepted and three jobs created, but official parser/pack prerequisites were zero-step DEN-977 rejections, so no archive or Actions artifact exists yet |
...
| `.github` | [`#7`](https://github.com/messaging-intel/.github/pull/7) | `a9e2a7667c9aa836ed204430c69c53417df3bf2a` | `3716ad683a6051a7aaf12abe7a03c6fbb8c30721` | Baseline policy passed; provider-authorization and runtime-permission delivery evidence published |

These entries record merged source and test evidence. They do not claim that private credentials were provisioned, a Zed registry release or review artifact succeeded, live provider assets were registered, capture was enabled, a production cron was activated, or a Kubernetes deployment was performed.
...
- Run the merged private-Zed workflow through the pinned `zed-interfaces` parser and pinned `zed-cli pack`/`r2g` jobs; record the archive SHA-256 and artifact ID only after those jobs succeed. A configured workflow is not a built or published package.
